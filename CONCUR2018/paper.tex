...
$t=T$. \textcolor{red}{[ADD REFERENCE TO PUBLISHED WORK ON ABSTRACT ACCELERATION.]}
...
With respect to the additional complexity introduced by the synthesis
of observer-based controllers compared to fully observed systems, we
found that on average, observer synthesis is over an order of
magnitude slower than full state controller synthesis for the given
benchmarks. This is due to the fact that the introduction of the
