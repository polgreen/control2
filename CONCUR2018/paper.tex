...
Given the nature of the specifications, observer synthesis cannot be directly compared to full state controller synthesis. 
On average, we found the former to be over an order of magnitude slower for the given benchmarks, largely due to the fact that the introduction of the
observer doubles the order of the model.
