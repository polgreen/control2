...
In this work, equations~\eqref{eq:ode1} and~\eqref{eq:ode2} is soundly discretized in time (see Section~\ref{sec:cont_aa}) \todo{or use another paper as reference and remove sec .1?} into
\begin{align}
\label{eq:plant}
