...
\todo{we are interested in observable systems so this is the definitely the case...}
...
The expression
 ...
 \end{align}
 with $\mat{A}_T, \mat{B}_T$ as per \eqref{eq:continuous_tube_dyn} and $\mat{A}_d, \mat{B}_d$ describing the discretized plant dynamics is a witness of the system
 \begin{align}
 ...
 \end{theorem}
%
\todo{\eqref{eq:continuous_tube_dyn} does not define $\mat{B}_T$}
\todo{$\vec{u}_t$?}
%
%\begin{proof}
...
\end{theorem}
%
\todo{${\vec{y}_e}_{k}$ ?, notation $| |_x$ ?}
\todo{also, now we do have an output $y$, why didn't we consider this case at
\ref{sec:real_discrete_feedback_inputs}?}
%
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
where $\mat{G}$ is a matrix of template directions taken as row vectors \todo{unclear to me}, and $\vec{h}$ is an upper
