...
be true.  We must therefore find a suitable solution to maintain this independence of polynomials.
...
\end{equation}
%
In the case of $\mat{A}_c$, the procedure is the same except
...
\note{relate to polynomials sued above.}
...
%
\begin{equation}
P'=\prod_{i=0}^p (z-\lambda_i')=\prod_{i=0}^p \left(z-\frac{\lambda_i}{\overline{\lambda}}\right)=\sum_{j=0}^p \frac{c_j}{\overline{\lambda}^{p-j}}z^j, 
\end{equation}
%
