...
$\mat{A}_{c}$ the closed loop dynamics of the controller, $\mat{A}_{o}$ the closed loop dynamics of the observer, $\mat{B}_{o}$ the feedback gain, 
...
\models \phi$ \note{wrong notation: it's not that the eigenvalue satisfies a constraint - rather, the corresponding model does? }).  The resulting observer and controller are then
...
\# & \multicolumn{1}{|c|}{Benchmark} & \multicolumn{1}{|c|}{order} & \multicolumn{1}{|c|}{Number of} & \multicolumn{3}{|c|}{CEGIS} & \multicolumn{3}{|c|}{CEGIS-OR} \\
   &                                 & & \multicolumn{1}{|c|}{benchmarks}  & \multicolumn{1}{|c|}{Min} & \multicolumn{1}{|c|}{Median} & \multicolumn{1}{|c|}{t.o.} & \multicolumn{1}{|c|}{Min} & \multicolumn{1}{|c|}{Median} & \multicolumn{1}{|c|}{t.o.}\\\hline
1  & DC Motor          & 2 & 100 & 1.3\,s & 26.9\,s& 22& 1.1\,s &   3.8\,s & 2\\
2  & Helicopter        & 3  & 100 & 57.2\,s & t.o. & 54 & 7.1\,s  &   18.0\,s & 9\\
3  & Inverted Pendulum & 4 & 100 &   & \xmark &\xmark & 20.0\,s  &  348.1\,s & 19\\
4  & Magnetic Pointer  & 2  & 100 & 5.7\,s & 229.9\,s & 38 & 3.0\,s  &  9.5\,s & 7 \\
%5 & Magnetic Suspension          & 2 & 1 & 12.2\,s& 0.6\,s & & & N/A  &   N/A &   N/A\\
5  & Pendulum          & 2 & 100 & 0.8\,s & 53.6\,s & 33 &0.4\,s  &   4.9\,s & 6\\
6  & Suspension        & 4 & 100 & & & \xmark& &  & \xmark\\
7  & Tape Driver       & 3 & 100 & 4.0\,s& 17.7\,s & 11&3.1\,s  &   16.8\,s & 8\\
...
Experimental results. Minimum, and Median times for standard CEGIS vs CEGIS-OR on multiple benchmarks.  the t.o. column ~indicates number of timeouts. \note{It is unclear what the difference is btw t.o. used in the third column header, and that used within the table - the latter is corresponding to a cross?} \note{recall what a model order is.}}
\end{table}

Using the described technique we managed to synthesize controllers for \note{X} benchmarks, with a median synthesis time of $18.8$ seconds.
...
both approaches..}.
Another factor that brings an improvement of one order of
magnitude is the Abstraction Refinement and Optimization in CEGIS-OR
\note{on average/an improvement of up to an order of magnitude/for some specific case?}.
