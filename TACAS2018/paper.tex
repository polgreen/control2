...
and the response time in the presence of an observer. \footnote{A full description of
...
converge to a certain value. %% In our model, we are concerned with the latter
%% type of stability is directly related to
