...
\note{relate to polynomials sued above. justify use of different variable.}
...
\end{equation}
%
where all members \note{members?} are known. Thus, we can ensure that the settling time is smaller than
...
\note{At times the gain matrices K, L, do not appear with C/P indices  -  clarify why. }
