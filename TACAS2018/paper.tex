...
The expression
 ...
 kT_s \leq t < (k+1)T_s. 
 \end{align}
\note{shouldn't K be denoted with index, so that it belongs to the domain of the controller?}
 \end{theorem}
\begin{proof}
See Appendix~\ref{sec:proofs}
\end{proof}
...
\note{shouldn't K-L be denoted with index, so that it belongs to the domain of the controller?}}
\label{fig:CEGIS-OR}
\end{figure}
...
3  & Inverted Pendulum & 4 & 100 &  277\,s& t.o. & 25& 0 & 20.0\,s  &  t.o. & 37 & 19\\
...
6  & Suspension        & 4 & 100 &15.0\,s & 146.3\,s & 25 & 62 & 14.8\,s&166.9\,s  & 26 & 73\\
...
\note{I don't think this is stated before so explain it here.}
...
specification is tight, meaning that the standard CEGIS loop would require many iterations.
...
There are cases where newly found controllers are not due to the elimination of
timeouts, but to the fact that the optimiser can reason about infinite precision
