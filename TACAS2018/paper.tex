...
\begin{align}
|\vec{y}_{k}-{\vec{y}_{t_d}}_{k}|_\infty \leq q_t, \text{ where } q_t=&(|\mat{C}(\mat{B}_{T_s}-\mat{B}_{t_s})|_1+|\mat{C}\mat{A}_{t_s}\mat{B}_{t_d}|_1)|U|_\infty
\end{align}
...
Our abstraction refinement CEGIS loop is similar to CEGIS with solution generalization \cite{}.
