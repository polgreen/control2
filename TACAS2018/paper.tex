...
\begin{array}{ccc}k_{n-1}-a_{n-1}&\cdots&k_1-a_1\end{array}&k_0-a_0\\
\mat{I}&\begin{array}{c}0\\ \vdots \\ 0\end{array}
\end{array}\right]&
\mat{A}_o=&\left[\begin{array}{cc}
\begin{array}{c}l_{n-1}-a_{n-1}\\ \vdots\\ l_1-a_1\end{array}&\mat{I}\\
...
and~$\mat{A}_o$.  The introduction of the FWL errors causes this to no longer
