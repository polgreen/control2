...
%\end{align*}
%}
Moreover, $\nu_1$ and $\nu_2$ are the quantization noises introduced by the ADC and the DAC, $\nu_t$ is the noise introduced by the delay, and $\nu_1'$ and $\nu_2'$ are quantization noises caused by roundoffs in the FWL operations (details are in Appendix~\ref{sec:quantization-noise}).

In a continuous time domain, the characteristic polynomial
...
be true.  We must therefore find a suitable solution to maintain this separation of polynomials.
