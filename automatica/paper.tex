...
part and $M$ bits representing the mantissa part. Bounds for errors introduced by 
performing basic mathematical operators at this precision can be derived~\cite{DBLP:conf/arith/BrainTRW15}.
...
represented at the fixed-point precision of the plant model. We apply 
the same principles as in the preceding section when selection the plant precision.
