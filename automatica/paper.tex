...
these models are discretized with different sample times, which thus results in $167$ benchmarks
...
a frictionless pivot through a negligible mass rod, while the inverted pendulum 
...
The magnetic pointer benchmark is a pointer usually employed in analogue 
...
inertial frame during all the excursion. The springer-mass damper system benchmarks 
are classic models for several mechanical systems dynamics. These benchmarks describe a mass,
