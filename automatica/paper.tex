...
The naive back end uses the bit-precise modelling of finite-precision arithmetic in CBMC. We assume that the controller
...
CEGIS in general is not guaranteed to terminate if the search space is infinite. 
%-------------------------------
