...
\end{equation*}
\note{The characteristic polynomial $S(z)$ represents the dynamical model in \ldots [clarify whether we use the CPol to describe the open- or closed-loop model. Relate parameters to matrices A,B,K. ]}
...
\note{This is only for spiralling dynamics.}
