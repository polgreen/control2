...
A large body of work exists on evaluating fixed-point errors and bridging the gap between real value
and fixed-point values in synthesis in other application areas and using other
algorithmic techniques; 
Genetic programming has been used to minimise the error in synthesised fixed-point programs~\cite{Darulova};
Smoothed proof search reduces the problem of boolean  a sequence of optimization problems
