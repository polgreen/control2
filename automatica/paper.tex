...
There are two \textit{continuous stirred tank reactor} models that describes the PH dynamics of a neutralization 
reaction of an aqueous solution of sodium acetate with  hydrochloric acid (CSTR1)~\cite{cstr} and the temperature of a 
