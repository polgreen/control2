...
introduced by ADC/DAC conversion blocks of Figure \ref{DSSynth_process}, 
...
\textcolor{red}{[Where are we defining the specifications/properties of interest?]} 

\textcolor{red}{[Where are the specifics of the errors due to discretisation/quantisation discussed?]}
...
criterion, as well as the restrictions on the representation of these
...
\textcolor{red}{[Why are these specs discussed only here? Isn't this way too late? ]}
