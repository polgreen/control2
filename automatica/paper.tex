...
\textit{cstrtmp}, which describe the PH dynamics of a neutralization reaction 
...
\textit{springer-mass damper system} plant is a classic model for several mechanical 
