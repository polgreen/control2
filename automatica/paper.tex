...
%-------------------------------
\subsection{\textcolor{red}{[Elizabeth: please add the specifics of the errors due to discretisation/quantisation, with reference to Fig. \ref{fig:digitalsystem}]}}
%\label{sec:}
%-------------------------------
