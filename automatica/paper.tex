...
namely a quantitative safety requirement, which opens up to more complex specifications \note{[belta, tabuada]}. 
...
it can be shown that a discrete-time LTI system %as \eqref{eq:closedloopss} 
