...
\todo{keep next?} For clarity,  we also use \vold{v1} and \vnew{v2} in the response letter for referring respectively to the previous
...
safely rely on its current form, as it stands.  \todo{Add note to manuscript?}
...
\todo[inline]{Eli: can you clarify? Again, this is just Jury's criteria, we don't really have space to go over examples of basic control theory }

\todo{can we at least say that the values can be obtained form the SW tool, and say where in the tool they are computed? }
