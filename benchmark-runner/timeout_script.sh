...
echo "BENCHMARK: $benchmark"
 timeout 18000 ./completeness-threshold-ss-benchmark-runner.sh $benchmark $2

if [ $? -ne 0 ]; then
  echo "timeout $benchmark" > /users/elipol/control-synthesis/benchmark-runner/timeouts.txt
fi
