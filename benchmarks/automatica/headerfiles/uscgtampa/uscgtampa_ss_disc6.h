...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(2.986537e+00),  interval(-1.486539e+00),  interval(9.865414e-01)},
...
const __plant_typet __char_poly_const[4][4] = 
 {{ 1,  0,  0,  0},
{ -2.986537e+00,  7.812500e-03,  0,  0},
{ 2.973079e+00,  0,  1.562500e-02,  0},
{ -9.865414e-01,  0,  0,  7.812500e-03}};
