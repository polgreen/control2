...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(2.995810e+00),  interval(-1.495809e+00),  interval(9.958088e-01)},
...
const __plant_typet __char_poly_const[4][4] = 
 {{ 1,  0,  0,  0},
{ -2.995810e+00,  5.000000e-01,  0,  0},
{ 2.991619e+00,  0,  1,  0},
{ -9.958088e-01,  0,  0,  5.000000e-01}};
