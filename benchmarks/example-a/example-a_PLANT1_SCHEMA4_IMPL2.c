...
void call_verification_task(void *verification_task)
{
  ...
  if((_Bool)0)
  {
    ...
    for( ; !(call_verification_task$$1$$i >= ds.b_size); call_verification_task$$1$$i = call_verification_task$$1$$i + 1)
    {
      if(ds.b_uncertainty[(signed long int)call_verification_task$$1$$i] > 0.000000)
      {
        ...
        double call_verification_task$$1$$1$$1$$1$$1$$min=ds.b[(signed long int)call_verification_task$$1$$i] - call_verification_task$$1$$1$$1$$1$$1$$factor;
        ...
        _Bool tmp_if_expr$1;
        if(ds.b[(signed long int)call_verification_task$$1$$i] >= call_verification_task$$1$$1$$1$$1$$1$$min)
    ...
    for( ; !(call_verification_task$$1$$i >= ds.a_size); call_verification_task$$1$$i = call_verification_task$$1$$i + 1)
    {
      ...
      {
        double factor=ds.a_uncertainty[(signed long int)call_verification_task$$1$$i];
        factor = factor < 0.000000 ? factor * (double)-1 : factor;
        double min=ds.a[(signed long int)call_verification_task$$1$$i] - factor;
        double call_verification_task$$1$$1$$2$$1$$1$$max=ds.a[(signed long int)call_verification_task$$1$$i] + factor;
        if((signed int)base_case_executed == 1 && IEEE_FLOAT_EQUAL(factor, 0.000000))
        ...
        _Bool tmp_if_expr$2;
        if(ds.a[(signed long int)call_verification_task$$1$$i] >= min)
  ...
  else
  {
    ...
    for( ; !(i >= ds.a_size); i = i + 1)
    {
      ...
      {
        double call_verification_task$$1$$2$$2$$1$$1$$factor=(ds.a[(signed long int)i] * ds.a_uncertainty[(signed long int)i]) / 100.000000;
        ...
        double call_verification_task$$1$$2$$2$$1$$1$$min=ds.a[(signed long int)i] - call_verification_task$$1$$2$$2$$1$$1$$factor;
        double call_verification_task$$1$$2$$2$$1$$1$$max=ds.a[(signed long int)i] + call_verification_task$$1$$2$$2$$1$$1$$factor;
