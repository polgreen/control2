...
void call_closedloop_verification_task(void *closedloop_verification_task)
{
  ...
  for( ; !(i >= plant.b_size); i = i + 1)
  {
    if(plant.b_uncertainty[(signed long int)i] > 0.000000)
    {
      ...
      double max=plant.b[(signed long int)i] + call_closedloop_verification_task$$1$$1$$1$$1$$factor;
  ...
  for( ; !(i >= plant.a_size); i = i + 1)
  {
    if(plant.a_uncertainty[(signed long int)i] > 0.000000)
    {
      ...
      double call_closedloop_verification_task$$1$$2$$1$$1$$max=plant.a[(signed long int)i] + factor;
