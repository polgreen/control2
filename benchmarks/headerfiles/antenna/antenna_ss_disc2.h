...
// stable. safety not checked, completeness k with no controller = 206366755
#ifndef INT_BITS 
#define INT_BITS 8
#define FRAC_BITS 8
#endif
...
const __plant_typet __char_poly_const[7][7] = 
 {{ 1,  0,  0,  0,  0,  0,  0},
{ -1.503634e+00,  3.906250e-03,  0,  0,  0,  0,  0},
{ -1.210708e-01,  0,  3.906250e-03,  0,  0,  0,  0},
{ 6.991028e-01,  0,  0,  3.906250e-03,  0,  0,  0},
{ -1.436128e-02,  0,  0,  0,  1.953125e-03,  0,  0},
{ -6.613367e-02,  0,  0,  0,  0,  9.765625e-04,  0},
{ 6.096747e-03,  0,  0,  0,  0,  0,  1.220703e-04}};
