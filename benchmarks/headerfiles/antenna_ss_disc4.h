...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(4.473822e+00),  interval(-2.140084e+00),  interval(1.132605e+00),  interval(-7.019233e-01),  interval(2.400616e-01),  interval(-1.397155e-01)},
