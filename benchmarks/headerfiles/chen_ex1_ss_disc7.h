...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(2.994007e+00),  interval(-1.494012e+00),  interval(4.970090e-01)},
...
const __plant_typet __char_poly_const[4][4] = 
 {{ -1,  0,  0,  0},
{ 2.994007e+00,  0,  0,  -3.051758e-05},
{ -2.988025e+00,  0,  -6.103516e-05,  0},
{ 9.940180e-01,  -6.103516e-05,  0,  0}};
