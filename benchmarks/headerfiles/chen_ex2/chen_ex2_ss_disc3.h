...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(5.540349e+00),  interval(-3.321083e+00),  interval(2.248482e+00),  interval(-9.393281e-01),  interval(4.953709e-01),  interval(-3.216924e-01),  interval(1.174609e-01),  interval(-7.376633e-02)},
