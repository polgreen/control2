...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(6.586401e+00),  interval(-4.730041e+00),  interval(1.934807e+00),  interval(-9.859541e-01),  interval(6.408586e-01),  interval(-2.593960e-01),  interval(1.195390e-01),  interval(-9.602495e-02)},
