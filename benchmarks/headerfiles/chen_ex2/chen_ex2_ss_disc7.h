...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(7.967107e+00),  interval(-3.471273e+00),  interval(1.728495e+00),  interval(-1.075863e+00),  interval(8.571470e-01),  interval(-4.268084e-01),  interval(2.428857e-01),  interval(-2.418846e-01)},
