...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(2.136696e+00),  interval(-9.312093e-01),  interval(4.086816e-01),  interval(-1.824322e-01),  interval(7.996664e-02),  interval(-3.102171e-02),  interval(1.618798e-02),  interval(-8.946455e-03)},
