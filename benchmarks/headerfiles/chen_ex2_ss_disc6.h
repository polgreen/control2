...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(7.837652e+00),  interval(-3.359270e+00),  interval(1.645435e+00),  interval(-1.007421e+00),  interval(7.894712e-01),  interval(-3.866572e-01),  interval(2.164176e-01),  interval(-2.119734e-01)},
