...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(5.433322e+00),  interval(-3.203438e+00),  interval(2.125692e+00),  interval(-8.573825e-01),  interval(4.205040e-01),  interval(-2.322895e-01),  interval(1.115651e-01)},
