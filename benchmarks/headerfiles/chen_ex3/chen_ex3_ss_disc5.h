...
// stable. safety not checked, completeness k with no controller = 315
#ifndef INT_BITS 
#define INT_BITS 8
#define FRAC_BITS 8
#endif
...
const __plant_typet __char_poly_const[8][8] = 
 {{ -1,  0,  0,  0,  0,  0,  0,  0},
{ 6.848902e+00,  0,  0,  0,  0,  0,  0,  -1.562500e-02},
{ -2.010582e+01,  0,  0,  0,  0,  0,  -6.250000e-02,  0},
{ 3.279496e+01,  0,  0,  0,  0,  -2.500000e-01,  0,  0},
{ -3.209967e+01,  0,  0,  0,  -5.000000e-01,  0,  0,  0},
{ 1.885395e+01,  0,  0,  -5.000000e-01,  0,  0,  0,  0},
{ -6.153027e+00,  0,  -2.500000e-01,  0,  0,  0,  0,  0},
{ 8.607080e-01,  -6.250000e-02,  0,  0,  0,  0,  0,  0}};
