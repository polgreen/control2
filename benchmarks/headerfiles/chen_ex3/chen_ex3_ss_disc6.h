...
// stable. safety not checked, completeness k with no controller = 599
#ifndef INT_BITS 
#define INT_BITS 8
#define FRAC_BITS 8
#endif
...
const __plant_typet __char_poly_const[8][8] = 
 {{ -1,  0,  0,  0,  0,  0,  0,  0},
{ 6.924719e+00,  0,  0,  0,  0,  0,  0,  -7.812500e-03},
{ -2.055142e+01,  0,  0,  0,  0,  0,  -3.125000e-02,  0},
{ 3.388622e+01,  0,  0,  0,  0,  -1.250000e-01,  0,  0},
{ -3.352508e+01,  0,  0,  0,  -2.500000e-01,  0,  0,  0},
{ 1.990133e+01,  0,  0,  -2.500000e-01,  0,  0,  0,  0},
{ -6.563512e+00,  0,  -1.250000e-01,  0,  0,  0,  0,  0},
{ 9.277435e-01,  -3.125000e-02,  0,  0,  0,  0,  0,  0}};
