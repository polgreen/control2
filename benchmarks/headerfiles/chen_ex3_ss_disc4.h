...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(6.227552e+00),  interval(-2.084317e+00),  interval(1.555262e+00),  interval(-6.985732e-01),  interval(3.777753e-01),  interval(-2.277524e-01),  interval(1.180916e-01)},
