...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(6.984989e+00),  interval(-2.613757e+00),  interval(2.173465e+00),  interval(-1.084407e+00),  interval(6.492520e-01),  interval(-4.319093e-01),  interval(2.462780e-01)},
...
{ -2.091006e+01,  0,  0,  0,  0,  0,  -7.812500e-03,  0},
