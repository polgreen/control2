...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(8.954366e+00),  interval(-4.454575e+00),  interval(2.585434e+00),  interval(-1.929364e+00),  interval(9.598707e-01),  interval(-6.367355e-01),  interval(5.430738e-01),  interval(-2.701995e-01),  interval(2.389994e-01)},
...
{ 1.228634e+02,  0,  0,  0,  0,  -6.103516e-05,  0,  0,  0,  0},
{ -8.150214e+01,  0,  0,  0,  -6.103516e-05,  0,  0,  0,  0,  0},
