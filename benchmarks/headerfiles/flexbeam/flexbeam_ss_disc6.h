...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(5.983490e+00),  interval(-3.732253e+00),  interval(2.485140e+00),  interval(-9.315124e-01),  interval(3.727270e-01),  interval(-2.487581e-01)},
...
{ 1.490420e+01,  0,  0,  1.250000e-01,  0,  0,  0},
{ -5.963632e+00,  0,  1.250000e-01,  0,  0,  0,  0},
{ 9.950324e-01,  3.125000e-02,  0,  0,  0,  0,  0}};
