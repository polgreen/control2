...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(4.002501e+00),  interval(-1.501250e+00),  interval(1.000625e+00),  interval(-5.000000e-01)},
...
{ 6.005001e+00,  0,  0,  3.125000e-02,  0},
