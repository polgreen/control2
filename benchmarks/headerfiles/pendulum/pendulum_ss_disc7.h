...
// stable. safety not checked, completeness k with no controller = 202
#ifndef INT_BITS 
#define INT_BITS 8
#define FRAC_BITS 8
#endif
...
const __plant_typet _controller_A[NSTATES][NSTATES] = {{ interval(1.999019e+00),  interval(-1)},
{ interval(1),  interval(0)}};
const __plant_typet _controller_B[NSTATES] = {interval(2.500000e-01), interval(0)};
const __plant_typet __char_poly_const[3][3] = 
 {{ 1,  0,  0},
{ -1.999019e+00,  2.500000e-01,  0},
{ 1,  0,  2.500000e-01}};
