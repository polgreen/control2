...
satellite_ss_disc1=ss(satellite_tf_disc1);
satellite_ss_disc2=ss(satellite_tf_disc1);
satellite_ss_disc3=ss(satellite_tf_disc1);
...
save('benchmark_tf','satellite_tf_disc1','satellite_tf_disc2',...
    'satellite_tf_disc3','cruiseHSCC_tf_disc1',...
    'springmassdamperHSCC_tf_disc1','-append')
save('benchmark_ss','satellite_ss_disc1','satellite_ss_disc2',...
    'satellite_ss_disc3','cruiseHSCC_ss_disc1',...
    'springmassdamperHSCC_ss_disc1','-append')