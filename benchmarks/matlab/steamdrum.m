...
steamdrum_tf_disc1=pade_delay1*c2d(steamdrumd,ts);
steamdrum_ss_disc1=ss(steamdrum_tf_disc1);

%% Discretizing with Ts=0.2

ts=0.2;
pade_delay2=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc2=pade_delay2*c2d(steamdrumd,ts);
...
ts=0.25;
pade_delay3=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc3=pade_delay3*c2d(steamdrumd,ts);
...
ts=0.6;
pade_delay4=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc4=pade_delay4*c2d(steamdrumd,ts);
...
ts=0.75;
pade_delay5=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc5=pade_delay5*c2d(steamdrumd,ts);
...
ts=1.2;
pade_delay6=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc6=pade_delay6*c2d(steamdrumd,ts);
...
ts=1.5;
pade_delay7=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc7=pade_delay7*c2d(steamdrumd,ts);
steamdrum_ss_disc7=ss(steamdrum_tf_disc7);

%% Discretizing with Ts=1.75

ts=1.75;
pade_delay8=thiran(steamdrumd.InputDelay,ts);
steamdrum_tf_disc8=pade_delay8*c2d(steamdrumd,ts);
