  ...
  else
  {
    ...
    for( ; !(call_verification_task$$1$$2$$i >= ds.a_size); call_verification_task$$1$$2$$i = call_verification_task$$1$$2$$i + 1)
    {
      if(ds.a_uncertainty[(signed long int)call_verification_task$$1$$2$$i] > 0.000000)
      {
        ...
        double min=ds.a[(signed long int)call_verification_task$$1$$2$$i] - call_verification_task$$1$$2$$2$$1$$1$$factor;
        ...
        _Bool tmp_if_expr$4;
        if(ds.a[(signed long int)call_verification_task$$1$$2$$i] >= min)
