...
a continuous plant. Eq.~\ref{eq:ode} is soundly discretized 
...
%
\begin{equation}
\vec{u}_k=\mat{K}_d\vec{y}_k\ \ :\ \ \mat{K}_d \in \mathbb{R}^{m \times o}.
\end{equation}
%
...
%
\begin{align*}
\mat{A} \in \mathcal{G}_A=\mat{S}\mat{J}\mat{S}^{-1} : \mat{J} \in \mathcal{G}_J \wedge
