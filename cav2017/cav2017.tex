...
%-------------------------------
In this study, we focus on Linear Dynamical Cyber-Physical Systems with
continuous plants described by Ordinary Differential Equations (ODEs) 
in the form
%
\begin{align}
\label{eq:ode}
...
$\vec{y}(t)$ represents an instantaneous output equation; and $\mat{A}$, 
$\mat{B}$, $\mat{C}$, and $\mat{D}$ are matrices that fully specify 
a digital system. Eq.~\ref{eq:ode} is soundly discretized 
(as shown in the appendix) into 
\textcolor{red}{Dario: Can you please describe all terms used in the equation?}
%
\begin{align}
\label{eq:plant}
...
is constructed). We further presume that there are small tolerances in the system 
