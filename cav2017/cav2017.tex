...
CEGIS and apply CEGAR on simplified abstractions of the system in
order to achieve scalability.  The former technique allows the
inductive generalisation engine to look for candidate solutions in a
reduced solution space.  The latter case is a well know technique for
abstract interpretation that allows simplification of the procedures
over a sound abstraction of the verification model.
