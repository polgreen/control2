...
required too many counterexamples to refine their solution \textcolor{red}{
(marked with $^*$ in Table~\ref{tab:results})}.  
...
our benchmarks. \textcolor{red}{Table~\ref{tab:results} only lists the faster of the two
