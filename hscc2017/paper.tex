...
%We briefly recall the standard foundations of this step.
...
% and the sampling and hold process. 
...
%the zero-order hold (ZOH) discretization is suitable for representing 
