...
is sufficient for stability studies over $G(s)$~\cite{fadali}, {\it i.e.}, if there is any unstable pole domain ($\Re\{s\}\geq 0$), the pulse transfer function~\ref{eq:pulsetf} will also present the same number of unstable poles ($|z|<1$)~\cite{Franklin15}.
