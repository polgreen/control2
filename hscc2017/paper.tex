...
the pulse transfer function~\eqref{eq:pulsetf} will also present the same number of unstable poles ($|z| > 1$)~\cite{Franklin15}.
...
2. errors in the numerical calculations (\red{denoted \ldots}); 
and 3. roundoffs in the quantization (\red{denoted \ldots}).  
