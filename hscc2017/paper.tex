...
The first set of benchmarks uses the discrete plant $G_1(z)$ of a cruise control
...
%\end{equation} 
%
The second set of benchmarks considers the discrete plant $G_2(z)$ 
of a simple spring-mass damper~\cite{DBLP:conf/hybrid/WangGRJF16}. 
%where the discrete 
...
%\end{equation} 
%
A third set of benchmarks uses the discrete plant $G_{3}(z)$ for satellite
...
%\end{equation}
%
The fourth set of benchmarks considers the discrete plant $G_{4}(z)$
...
The fifth set of benchmarks contains the \textit{DC Motor Rate} discrete plant $G_{5}(z)$, which 
describes the angular velocity of a DC Motor~\cite{Franklin15}. 
%
%\begin{equation}
%\label{DC-Motor-Rate}
...
%\end{equation}
%
The sixth set of benchmarks contains the \textit{Helicopter Longitudinal Motion} discrete plant $G_{6}(z)$,
which provides the longitudinal motion model of a helicopter~\cite{Franklin15}. 
%
%\begin{equation}
...
%\end{equation}
%
The seventh set of benchmarks contains the \textit{Inverted Pendulum} discrete plant $G_{7}(z)$, which 
describes a pendulum model with its center of mass above its pivot point~\cite{Franklin15}. 
%
%\begin{equation}
...
%\end{equation}
%
The eighth set of benchmarks contains the \textit{Magnetic Suspension} discrete plant $G_{8}(z)$,
which provides a model for which a given object is suspended via magnetic field~\cite{Franklin15}. 
%
%\begin{equation}
...
The ninth set of benchmarks contains the \textit{1/4 Car Suspension} discrete plant $G_{9}(z)$,
which presents a model that connects a car to its wheels and allows relative motion between both parts~\cite{Franklin15}.
%
%\begin{equation}
...
%\end{equation}
%
The tenth set of benchmarks contains the \textit{Computer Tape Driver} discrete plant $G_{10}(z)$, which 
...
%\end{equation}
The last two set of benchmarks describe discrete plants $G_{11}(z)$ and $G_{12}(z)$ 
for a DC servo motor application (e.g., velocity control)~\cite{exampleCAD,Tan01}.
