...
\item Experimental results show that \tool is able to efficiently synthesize
  ...
  literature: the median runtime for our benchmark set with the two-stage 
  verification engine is $52$\,s, i.e.,
...
However, the benchmark \emph{SatelliteB2} with uncertainty (represented by $G_{3b}$
in Table~\ref{tab:results}) required too many counterexamples to refine its solution.  
...
lists the results for both engines independently, where in $16$ out of $23$
...
\# & Plant  & Benchmark                  & $I$ & $F$
   & 2-stage & 1-stage
    \\\hline\hline
1  & $G_{1a}$  & CrsControl02
            &   4 &  16 & 12\,s   & 67\,s     \\
2  & $G_{1b}$  & CrsControl02$^\dagger$
            &   4 &  16 & 14600\,s   & 52\,s     \\
3  & $G_{2a}$  & SpgMsDamper
            &  15 &  16 & 52\,s   & 318\,s     \\
...
The median run-time for our benchmark set with the two-stage verification engine is 
$52$\,s, implying that \tool
...
footnote.\footnote{\url{http://www.cprover.org/DSSynth/experiment.tar.gz}}\footnote{CBMC version: 7a6cec1dd0eb8843559591105235f1f2c4678801}
