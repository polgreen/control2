...
If a candidate solution is validated by the verifier, it is necessarily
sound. 
...
bounds that could make some (or all) plant(s) unstable. This means
that whilst the solution may not be complete, it is sound for
evaluating any collection of real plants with a defined FWL controller
for all of them. We require two verification stages because,
while the second phase can ensure the stability of all plants in
the collection, it is unable to provide a counterexample.
