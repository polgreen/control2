...
dynamics~\cite{Franklin15}.  Satellites require attitude (pose) control
...
%\end{equation}
%
The fourth set of benchmarks considers the discrete model $G_{4}(z)$
...
%\end{equation}
%
The sixth set of benchmarks contains the \textit{Helicopter Longitudinal Motion} discrete model $G_{6}(z)$,
...
%\end{equation}
%
The seventh set of benchmarks contains the \textit{Inverted Pendulum} discrete model $G_{7}(z)$, which 
...
%\end{equation}
%
The eighth set of benchmarks contains the \textit{Magnetic Suspension} discrete model $G_{8}(z)$, which describes the dynamics of a mass that levitates with support only of a magnetic field~\cite{Franklin15}. 
%
%\begin{equation}
...
%\end{equation}
%
The tenth set of benchmarks contains the \textit{Computer Tape Driver} discrete model $G_{10}(z)$, which 
...
%\end{equation}
The eleventh benchmark describe the discrete model of a DC servo motor velocity dynamics~\cite{exampleCAD,Tan01}. 

The last benchmark contains the discrete well-studied non-minimal phase model $G_{12}(z)$. Non-minimal phase model offers additional difficulties for the controller design~\cite{Doyle:1991:FCT:574259}.
...
The median runtime for our benchmark set is $48$\,s, implying that \tool
