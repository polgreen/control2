...
large amount preventing any single controller from stabilizing such a collection).
This is a reasonable assumption since most tolerances do not change the 
architecture of the plant, and models subject to such effects are simply
inadequate as a proposed solution.
