...
Considering the faster engine for each benchmark (marked as bold in Table~\ref{tab:results}), 
the median run-time amounts to $48$\,s, implying that \tool can synthesize half of the controllers 
in less than one minute. Overall, the average fastest synthesis time considering
both engines is approximately $42$ minutes.  We
