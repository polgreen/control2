...
\red{[wait I'm confused: the next should be a tilde!!]}
%
\begin{equation}
...
\textcolor{green}{The presence of uncertainty in some particular benchmarks ($2$, $4$, $6$, and $8$) 
...
\red{[what does this alpha-numerical code mean?]}
\textcolor{green}{CBMC (SHA-1 hash) version:} 7a6cec1dd0eb8843559591105235f1f2c4678801}
