...
thus, 
the uncertain model may be rewritten as a vector of coefficients in the z-domain using equation \eqref{eq:hatgvector} as  
%
%\begin{equation}
...
us to simultaneously evaluate \blue{[unclear:] the whole collection of plants $\hat{G}(s)$}
