...
Given our primary interest in stability despite digitization effects, we have modeled
...
\item We design and implement an automatic approach in a tool called \tool  
  ...
  representation of the plant is key to the performance of our approach yielding,
...
is able to efficiently synthesize stable controllers for a set of intricate benchmarks 
taken from the literature: the median runtime for our benchmark 
