...
domain.  
\cdsay{integrate the following with Dario}
...
higher precision:
\cdsay{Pascal, this sounds confusing. if you want to increase precision on-the-fly, i.e. 
not going back to the synthesise phase, 
