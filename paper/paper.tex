...
\textcolor{red}{Can you relate the benchmarks in Table~\ref{tab:results} in terms of $C$ and $G$ as described in section~\ref{experimental-setup}}
...
\caption{Experimental results. \textcolor{red}{It should be a table and not a figure.} \label{tab:results}}
\end{figure}
%---------------------------------
