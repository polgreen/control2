...
out of $15$ benchmarks within reasonable time frames.  For the 1 remaining benchmark
our approach failed to synthesise a stable controller in the requested time limits.
This can be addressed by either increasing the fixed point word widths considered or
