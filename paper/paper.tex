...
The discrete plant of a cruise control model with time step
of 0.2s for the car accounting for rolling friction, aerodynamic drag, 
and gravitational disturbance force is considered~\cite{Astrom08} 
as follows
%
\begin{equation}
\label{cruise-control-c1}
G(z)=\frac{0.0264}{z-0.998}. \nonumber
\end{equation} 
