...
Given a specification $\sigma$ over variables $x$
and $P$, the {\sc synth} procedure tries to find an existential witness $P$
...
loop adds a new input to the finite set $\text{\sc inputs}$  being used for synthesis.  If
