...
\textcolor{red}{Pascal: can you please update this section to include the CEGIS step?}
...
We compute the controller $(N_c,D_c)$ in the domain 
$\mathbb{R}\langle I,F \rangle$ and 
the uncertainty in $\mathbb{R}\langle I_b,F_b \rangle$.
...
phase, we thus retrieve a candidate solution with all coefficients 0.
The {\sc verify} phase now provides the first counterexample at higher
precision:
%
%$$
%\begin{array}{ll}
...
\textcolor{red}{Pascal: Can you please check whether this configuration is correct?}
...
did not meet these criteria (marked with $^*$ in Table~\ref{tab:results}). In these cases, 
...
\textcolor{red}{Pascal: Can you please add FWL for each synthesized controller using the following format <I,F>, where I represents the number of bits in the integer part and F represents the number of bits in the fractional part?}

\begin{table}[H]
\centering
\begin{tabular}{c | l | r l}
Plant & Benchmark                  & Time    & \\\cline{1-3}
$G_1$ & CruiseControl02            & 17\,s   & \\
$G_1$ & CruiseControl02$^\dagger$  & 46\,s   & \\
$G_2$ & SpringMassDamper           & 28\,s   & \\
$G_2$ & SpringMassDamper$^\dagger$ & \xmark  & \\
$G_3$ & SatelliteB2                & 7\,s    & \\
$G_3$ & SatelliteB2$^\dagger$      & 6601\,s & \tbmark\\
$G_3$ & SatelliteC2                & 2\,s    & \\
$G_3$ & SatelliteC2$^\dagger$      & 76\,s   & \tbmark\\
$G_4$ & a\_PL1\_SCH2\_IMPL1        & 2704\,s & \\
$G_4$ & a\_PL1\_SCH2\_IMPL2        & 538\,s  & \\
$G_4$ & a\_PL1\_SCH2\_IMPL3        & 12\,s   & \\
$G_4$ & a\_PL1\_SCH3\_IMPL1        & 318\,s  & \\
$G_4$ & a\_PL1\_SCH3\_IMPL2        & 967\,s  & \\
$G_4$ & a\_PL1\_SCH3\_IMPL3        & 9798\,s & \\
$G_4$ & a\_PL1\_SCH4\_IMPL1        & 6304\,s & \\
\end{tabular}
...
for synthesising stable controllers in the 12 out of 15 benchmarks, and can be
complemented using the interval arithmetic back-end for 2 additional benchmarks,
where the inductive conjectures fail too frequently. Both back-ends together enabled controller
synthesis for 14 out of 15 benchmarks within reasonable time frames. \pksay{TODO: Upload full
experiments environment including README and result log files to anonymous Google Drive and
provide link here.}
