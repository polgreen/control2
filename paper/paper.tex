...
$G_{4}(s)$ extracted from Keel and Bhattacharyya~\cite{bhattacharyya97,keel_Bhattacharyya_examples}.
%
\begin{equation}
\label{exampleA}
...
seconds); and the controllers are synthesised using $4$, $8$, and $12$-bits.
