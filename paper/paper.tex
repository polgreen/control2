...
and we encompass the complete range of approximations, related to time discretisation, quantisation effects, 
...
converter (DAC). The quantization occurs because the DAC resolution may be different from the fixed point representation of the controller.  
...
%   \& \coordinate (aux0);
   ...
   \node[draw=none] (u) at ([xshift=1cm,yshift=.1cm]cz)  {u};
