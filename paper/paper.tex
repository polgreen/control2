...
\cdsay{Mention that the resulting systems are also expected to have certain properties, 
e.g. stability, which makes it even more difficult to synthesise the controllers?}

In this paper, we explore the automatic synthesis of 
