...
in the context of verifying the (so-called) robust non-fragile stability.
However, the authors do not consider the compete range of approximations, 
related to time discretisation, and quantisation effects. Additionally, they do not find 
a parametric solution for a digital controller given a continuous plant specification, 
in order to synthesize the controller implementation.
...
\param{20}{20} implementation format can be represented by the following
z-expression:
