...
calculations. If this check returns $false$, then we 
...
higher precision:
\cdsay{Pascal, this sounds confusing. if you want to increase precision on-the-fly, 
then this illustration doesn't follow the general diagram in Fig.5. 
We need to decide which direction we keep.}
%
$$
\begin{array}{ll}
