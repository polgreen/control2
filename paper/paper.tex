...
\end{equation}
Due to the nature of the methods used for stability check in this paper, we require that  the parametric errors in the plant have the same polynomial order as the plant itself (other errors are ensured to fulfill this property in our implementation). 
