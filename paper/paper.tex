...
\caption{System equivalent to the system in Figure~\ref{fig:sampledsystem} \red{please do not add a vector and a transfer function! what does that even mean?}\label{fig:digsystem1}}
\end{figure*}
...
Lemma~\ref{lemma:eq_int_stab} \red{not a lemma} provides the necessary conditions for the digital controller to stabilize the closed loop system, 
...
Lemma~\ref{lemma:eq_int_stab} \red{not a lemma} are satisfied and if the quantisation noise is
