...
Jury's algorithm is used to check the stability in the $z$-domain
for a given characteristic polynomial of the form:
%
$$
...
\item $R_2: (−1)^N S(−1) > 0$;
\item $R_3: |a_0| < a_N$;
\item $R_4: m_{11} > 0 \equiv m_{31} \wedge m_{51} \wedge \cdots \wedge m_{(2N−3)(1)}$.
\end{itemize}
