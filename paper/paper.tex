...
benchmarks.  Nevertheless, the set of benchmarks is limited within the scope
of this paper and \tool's performance may not generalise to other
application scenarios.  This can be addressed by expanding the benchmark set
in future experiments.

Furthermore, our algorithm for selecting the fixed-point precision to model
