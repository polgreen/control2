...
\item We provide experimental results showing that
our fully automatic program synthesis based approach is able to synthesise 
stable controllers
%sound parametric solutions for digital stabilizing controllers
for a set of intricate benchmarks taken from 
the literature in a reasonable amount of time 
(the median runtime for our benchmark set is 197s, 
implying that half of the controllers can be synthesised in less
than 5 minutes). 
