...
%
Future work will be the extension of this CEGIS-based approach for different
classes of systems (e.g., state-space).  We will also consider performance
requirements while synthesising the digital controller.
