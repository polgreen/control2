...
\begin{frame}[fragile]{Hybrid Dynamical System}{Continuous Plant and Digital Controller}
...
\hat{Y}(z)=\frac{\nu_{1}(z)}{1+\hat{G}(z) \tilde{C}(z)}+\frac{\nu_{2}(z)\hat{G}(z)}{1+\hat{G}(z) \tilde{C}(z)}+\frac{R(z)\hat{G}(z) \tilde{C}(z)}{1+\hat{G}(z) \tilde{C}(z)}
\end{equation*}
}
...
\begin{frame}[fragile]{Our CEGIS Model}
\begin{figure}[htb]
\centering
\resizebox{1.0\textwidth}{!}
{
