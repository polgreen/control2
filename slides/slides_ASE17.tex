...
\item {\bf Automated synthesis of state-space and transfer-function representations that ensures stability and safety}

\item {\bf DSSynth is the first fully automated synthesis tool that is algorithmically and numerically sound}

\item {\bf We will pursue the application of CEGIS to program repair or superoptimization}
