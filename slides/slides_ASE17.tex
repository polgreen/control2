...
\uncover<2>{
 %\vspace{-.5cm}
  \small
{\bf Automatically synthesise feedback digital controllers}}
...
%
\centering
 \includegraphics[width=.5\textwidth]{figures/closedloopfeedback.jpg} 
 ...
 \uncover<2->{\1 Stability of closed-loop systems
   \2 A linear system is stable if it presents a bounded response for any bounded excitation}
