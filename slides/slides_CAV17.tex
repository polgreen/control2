...
\vspace{-1cm}
  \begin{center}
    \only<1>{\includegraphics[width=.8\textwidth]{figures/spirals/diagram-14.png}}
    \only<2>{\includegraphics[width=.8\textwidth]{figures/spirals/diagram-15.png}}
  \end{center}
  
  {\bf Continuous-discrete system}
  \begin{itemize}
  \item \colorbox{green!70}{Plant:
...
\begin{frame}{Translation to digital domain}
\vspace{-1cm}
  \begin{center}
    \includegraphics[width=.8\textwidth]{figures/spirals/diagram-16.png}
  \end{center}
  
  {\bf Continuous-discrete system}
  \begin{itemize}
  \item \colorbox{azure!70}{Plant:
    \textsc{$x_{k+1} = A x_k+ B u_k, \quad k \in \mathbb \mathbb N,~x_0=initial~state$}}
\item \colorbox{azure!70}{State-feedback controller:   $u_k = - C x_k$}
\end{itemize}
\end{frame}
...
\begin{frame}{The synthesis problem}
  ...
  \small
    ...
    \colorbox{azure!70}{Plant:
   \textsc{$x_{k+1} = A x_k+ B u_k, \quad k \in \mathbb \mathbb N$}}\\
   \colorbox{azure!70}{State-feedback controller:   $u_k = - C x_k$}

  
  {\bf Synthesise a controller {\color {red} C} that makes the system
...
%\begin{tabular}{l}
  ...
  %\begin{center}
\centering
  \includegraphics[width=.7\textwidth]{figures/spirals/Spirals-01.png}
 }
  %\end{center} 
%  
%  {\bf Continuous-discrete system}
...
%%   \centering
%%   \hspace{1cm}
%\includegraphics[width=.55\textwidth]{figures/spirals/Spirals-01.png}
